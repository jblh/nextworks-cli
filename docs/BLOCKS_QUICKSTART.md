...
> ```
>
> Passing `--sections --templates` ensures you get both the reusable sections and the full page templates. The CLI will copy the same files into your project under `components/`, `app/templates/`, `lib/`, and `public/` as described below.
